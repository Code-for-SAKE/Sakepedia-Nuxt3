...
const schema = object({
  makedBY: number().nullable(),
  aminoAcidContentMin: number().nullable(),
  aminoAcidContentMax: number().nullable(),
  alcoholContentMin: number().nullable(),
  alcoholContentMax: number().nullable(),
  sakeMeterValueMin: number().nullable(),
  sakeMeterValueMax: number().nullable(),
  acidityMin: number().nullable(),
  acidityMax: number().nullable(),
  ricePolishingRateMin: number().nullable(),
  ricePolishingRateMax: number().nullable(),
  sakeYeast: string().nullable(),
  riceForMakingKoji: string().nullable(),
  sakeRiceExceptForKojiMaking: string().nullable(),
  bottledDate: date().nullable(),
