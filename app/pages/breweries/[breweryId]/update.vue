...
const schema = object({
  breweryId: string().max(13, "13桁以内で入力してください").nullable(),
  ...
  fax: string().nullable(),
  url: string().nullable(),
  ecurl: string().nullable(),
  facebook: string().nullable(),
  twitter: string().nullable(),
  instagram: string().nullable(),
  othersns: string().nullable(),
  hasVisit: boolean().nullable(),
  visit: string().nullable(),
  hasTasting: boolean().nullable(),
  tasting: string().nullable(),
  hasCafe: boolean().nullable(),
  cafe: string().nullable(),
  hasShop: boolean().nullable(),
  shop: string().nullable(),
  hasOtherBrewing: boolean().nullable(),
  otherBrewing: string().nullable(),
